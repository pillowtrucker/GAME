...
void Main()
{
    ...
    ui_widgets.each([&grid,&widget_types] (Array<std::pair<String,tc::TheracTextType>> row){
        auto label_row = row.map([&widget_types](std::pair<String,tc::TheracTextType> cell)
        {
